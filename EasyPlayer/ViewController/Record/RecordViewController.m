...
- (void)viewDidLoad {
    ...
    // 添加子ViewController
    RecordListViewController *controller1 = [[RecordListViewController alloc] init];
    controller1.url = self.url;
    ScreenShotListViewController *controller2 = [[ScreenShotListViewController alloc] init];
    controller2.url = self.url;
